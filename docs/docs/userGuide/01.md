...
Our team is actively expanding the features available in Ketty. Keep up-to-date by joining the [Ketty Forum](https://forum.ketty.community/), reviewing our [roadmap](https://miro.com/app/board/uXjVP89vFkc=/?share_link_id=340765697607) and getting in touch via the [Ketty mattemost channel](https://mattermost.coko.foundation/coko/channels/ketty) or by email at ketty@coko.foundation.